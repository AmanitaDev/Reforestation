...
public class TimeService {
    readonly TimeSettingsSO _settingsSo;
    ...
    public TimeService(TimeSettingsSO settingsSo) {
        this._settingsSo = settingsSo;
        currentTime = DateTime.Now.Date + TimeSpan.FromHours(settingsSo.startHour);
        sunriseTime = TimeSpan.FromHours(settingsSo.sunriseHour);
        sunsetTime = TimeSpan.FromHours(settingsSo.sunsetHour);
    ...
    public void UpdateTime(float deltaTime) {
        currentTime = currentTime.AddSeconds(deltaTime * _settingsSo.TimeMultiplier);
