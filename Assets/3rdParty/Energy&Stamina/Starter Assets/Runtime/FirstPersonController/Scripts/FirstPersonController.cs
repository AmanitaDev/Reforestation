...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [Header("Stamina")] public ResourceBarTracker staminaTracker;
        public int staminaSprintCost = -10;
        public int staminaJumpCost = -10;
        ...
        private void Move()
        {
            ...
            if (_input.sprint)
            {
                // check stamina for sprinting and set speed according to response
                bool canSprint = staminaTracker.ChangeResourceByAmount(staminaSprintCost * Time.deltaTime);
                targetSpeed = canSprint ? SprintSpeed : MoveSpeed;
            }
            else
            {
